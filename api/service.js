...
const Services = [
  {
    ...
    sLang: "React / Next.js / Node.js / Express.js / Firebase",
    description:
  ...
  },
  {
    ...
    sLang: "React Native / Flutter / Firebase / Node.js",
    description:
      "Explain to you how all this mistaken idea of denouncing pleasure born and give you complete account the system.",
    des2: "Lacus, etiam sed est eu tempus need Temer diam congue laoret .",
    des3: "One way to categorize the activities is in terms of the professional’s area of expertise such as competitive analysis, corporate strategy the activities",
  ...
  },
  {
    ...
    sLang: "Adobe Photoshop / Illustrator / After Effects / Premiere Pro",
    description:
      "Explain to you how all this mistaken idea of denouncing pleasure born and give you complete account the system.",
    des2: "Lacus, etiam sed est eu tempus need Temer diam congue laoret .",
    des3: "One way to categorize the activities is in terms of the professional’s area of expertise such as competitive analysis, corporate strategy the activities",
